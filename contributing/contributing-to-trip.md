# Contributing to the TRIP Guides

This guide covers how _you_ can become a part of the ongoing development of the TRIP Guides.

After reading this guide, you will know:

* How to contribute to the TRIP Guides.
* How to use GitHub to create an issue.
* How to use GitBook to create a guide.

TRIP is everyone's protocol. So far, dozens of people have contributed to the TRIP Guides ranging from a single character to massive protocol design changes or significant documentation - all to make TRIP better for everyone. Even if you don't feel up to writing code or documentation yet, there are various other ways that you can contribute, from proposing guides to building the community.
...
To more effectively coordinate the community's efforts, we have created the TRIP Guides you are reading here. TRIP Guides are designed to help you share TRIP effectively, and to help you understand how all of the pieces fit together.
...
If you feel something's missing from the TRIP Guides, search the [Issues](https://github.com/TeleportXYZ/TRIP-Guides/issues) on GitHub, in case it has already been proposed. If you cannot find any open GitHub issues addressing the issue you've identified, your next step will be to [open a new issue](https://github.com/TeleportXYZ/TRIP-Guides/issues/new).
...
When making changes for the TRIP Guides, here are some things to keep in mind:

* Follow the TRIP Guides style and conventions.
* Use the TRIP Guides idioms and naming.
...
The TRIP Guides follows a simple set of writing style conventions:
...
Additionally, we recommend using [Hemingway](https://hemingwayapp.com/) to improve the readability of your contributions. Please copy and paste your writing into Hemingway before submitting a change request. We also recommend reading [The Elements of Style](https://www.amazon.com/Elements-Style-Fourth-William-Strunk/dp/020530902X) to improve your writing further.
...
Some contributors to the TRIP Guides have email notifications from GitBook turned on, but others do not. Furthermore, many who work on the TRIP Guides are volunteers, and so it may take a few days for you to get your first feedback on a change request. Don't despair! Sometimes it's quick; sometimes it's slow. Such is the open source life.
...
### TRIP Guides Contributors

All contributions get credit in the [TRIP Guides Contributors](contributors.md).
